...
<details>
<summary>반경검색 기능 추가</summary>
  
**배경**

  * 현 위치 기준의 반경 내 추천 장소를 표시해주는 기능에 대한 요청

**기능 설명**

  * 반경 검색은 사용자의 현재 위치 정보를 활용
  * 유저의 현재 위치에서 일정 반경 내의 게시글들을 검색해 지도상으로 보여줌
  * 검색은 유저의 최초 위치를 기준으로 진행

</details>

<details>
<summary>태그 선택 UX 개선</summary>

**배경**

  *  태그 선택시 화면이 맨 처음으로 올라가는 현상이 불편하다는 의견

**기능 설명**

  * 태그 선택시 화면 위치가 유지 
  * 사용자는 원래의 위치에서 태그를 선택할 수 있게 되어 더욱 편리

</details>

<details>
<summary>특정 유저의 모든 글 보기 기능 추가</summary>

**배경**

  * 특정 유저가 작성한 모든 글을 볼 수 있는 기능에 대한 요청

**기능 설명**

  * 유저 프로필 사진을 클릭하면 해당 유저가 작성한 모든 글을 한 눈에 볼 수 있는 페이지로 이동

</details>

<details>
<summary>글쓰기 내용 유지</summary>

**배경**

  * 주소 선택 페이지를 방문한 후 복귀하면 글쓰기 내용이 초기화되는 문제

**기능 설명**

  * 주소 선택 페이지를 방문 후 복귀해도 글쓰기 내용이 초기화되지 않음
  * 웹페이지를 새로고침 할 경우, 모든 데이터가 삭제될 수 있음을 알리는 알림창이 표시됩니다. 이를 통해 사용자에게 데이터 손실을 사전에 경고함
